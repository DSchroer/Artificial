...
weapon[weapon_index.damage] = 11;
weapon[weapon_index.accuracy] = 9;
weapon[weapon_index.capacity] = 16;
weapon[weapon_index.remaining] = 16;
...
weapon[weapon_index.name] = "Assault Rifle";
