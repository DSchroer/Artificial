...
var percent_remaining = current_boss_health / max_boss_health;

var current_text = string(current_boss_health);
var max_text = string(max_boss_health);
var combined = "Azar, The Unbreakable";//current_text + '/' + max_text;
