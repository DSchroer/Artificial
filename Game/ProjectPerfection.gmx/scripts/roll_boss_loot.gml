...
gun1.data = inventory_spawn_gun_ext(roll_power(), item_quality.uncommon, 100);
var gun2 = instance_create(x - 250 + random(500), y + random(300), obj_item);
gun2.data = inventory_spawn_gun_ext(roll_power(), item_quality.uncommon, 100);
var gun3 = instance_create(x - 250 + random(500), y + random(300), obj_item);
gun3.data = inventory_spawn_gun_ext(roll_power(), item_quality.rare, 100);
