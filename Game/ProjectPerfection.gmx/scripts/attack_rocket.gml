///attack_rocket(weapon, x, y, direction, ignore)
...
case weapon_subtype.pistol:
    sfx_play_gun(snd_pistol_regular, true, 0.2);
    break;
case weapon_subtype.auto_rifle:
    sfx_play_gun(snd_assault_regular, true, 0.2);    
    break;
case weapon_subtype.heavy_rifle:
    sfx_play_gun(snd_heavy_regular, true, 0.2);
    break;
case weapon_subtype.sniper_rifle:
    sfx_play_gun(snd_sniper_regular, true, 0.2);    
    break;
case weapon_subtype.smg:
    sfx_play_gun(snd_smg_regular, true, 0.2);
    break;
case weapon_subtype.machine_gun:
    sfx_play_gun(snd_mg_regular, true, 0.2);
    break;
