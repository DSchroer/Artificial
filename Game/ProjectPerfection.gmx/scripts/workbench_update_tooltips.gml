...
lines1[1] = "Current upgrade: +" + string(7.5 * level) + "%";
if(level < obj_menu_workbench.max_hp_level)
{
    lines1[2] = "Next upgrade: +" + string(7.5 * (1 + level)) + "%";
}
...
lines2[1] = "Current upgrade: +" + string(7.5 * level) + "%";
if(level < obj_menu_workbench.max_regen_level)
{
    lines2[2] = "Next upgrade: +" + string(7.5 * (1 + level)) + "%";
}
