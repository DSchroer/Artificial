...
else
{
    var text;
    var i = 0;
    text[i++] = "|lime Thwander, The Hunter 1 `br |white Thwander was a member of a race of bipedal hunters that used traps for survival. She grew to love nature and hunting at a young age. As she formed a bond with nature, she began to dream of being the perfect hunter. ";
    ...
    text[i++] = "|silver Shuud M'ell, Voice of the Deep 1 `br |white Shuud M'ell hailed from a planet with large cave systems and strong magnetic forces. Eventually, her race could utilize these two things to their advantage, sacrificing their eyes to be able to echolocate.";
    text[i++] = "|silver Shuud M'ell, Voice of the Deep 2 `br |white As the civil war ensued, Shuud M'ell retreated underground until the sound of the fighting stopped. She too chose to bear the cube's burden so no one else could abuse its power. Of course, it was not a truly selfish act, for the cube allowed her to grow closer to the earth, taking on a new form and enhancing her natural abilities.";
