///attack_plasma(weapon, x, y, direction, ignore, play_sound, allow_sound_stacking)
...
case weapon_subtype.pistol:
    sfx_play_gun(snd_pistol_plasma, allow_sound_stacking, 0.2);    
    break;
case weapon_subtype.auto_rifle:
    sfx_play_gun(snd_assault_plasma, allow_sound_stacking, 0.2);    
    break;
case weapon_subtype.heavy_rifle:
    sfx_play_gun(snd_heavy_plasma, allow_sound_stacking, 0.2);    
    break;
case weapon_subtype.sniper_rifle:
    sfx_play_gun(snd_sniper_plasma, allow_sound_stacking, 0.2);        
    break;
case weapon_subtype.smg:
    sfx_play_gun(snd_smg_plasma, allow_sound_stacking, 0.2);        
    break;
case weapon_subtype.machine_gun:
    sfx_play_gun(snd_mg_plasma, allow_sound_stacking, 0.2);        
    break;
}
